  ...
  <body>
    ...
    <footer>
      <div class="container">
          ...
          <p><a href="#">Điều khoản sử dụng thông tin</a> | <a href="#">Chính sách bảo mật</a> | Lượt truy cập: <a href="http://www.reliablecounter.com" target="_blank"><img src="http://www.reliablecounter.com/count.php?page=itc.hatinh.gov.vn&digit=style/plain/6/&reloads=0" alt="" title="" border="0"></a><br /><a href="http://www.fabbly.com" target="_blank" style="font-family: Geneva, Arial; font-size: 9px; color: #330010; text-decoration: none;">3d models for sale</a</p>
      </div>
    </footer>
