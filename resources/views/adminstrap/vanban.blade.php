...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <div class="row">
          <div class="col-md-12">
            <form action="adminstrap/van-ban/tim-kiem" method="post">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-sm btn-default" onclick="return confirm('Bạn muốn sửa mục này?')" data-toggle="modal" data-target="#editVanBan{{$vb->id}}">Edit</a>
              <a class="btn btn-sm btn-danger" onclick="return confirm('Bạn muốn xóa mục này?')" href="/adminstrap/xoa-van-ban/{{$vb->id}}">Delete</a>
            </td>
          </tr>
